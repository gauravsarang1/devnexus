...
const DashboardHero: React.FC<{ currentUser?: User;}> = ({
  currentUser,
}) => {
  ...
  return (
    <section className="pt-32 md:pt-40 pb-8 px-4 md:px-6">
      <motion.div
        ...
        className="max-w-7xl mx-auto bg-blue-50/50 border border-blue-100/50 rounded-4xl p-8 md:p-12 relative overflow-hidden"
      >
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-slate-600 mb-8 max-w-md">
            You have 3 new matching requests for your{" "}
