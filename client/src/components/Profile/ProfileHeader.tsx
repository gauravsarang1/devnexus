    ...
    <section className="bg-white rounded-[40px] border border-slate-100 shadow-sm relative overflow-hidden mb-8">
      ...
      <div className="p-6 md:p-10 pt-0 -mt-12 relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8 text-center md:text-left">
        ...
        <div className="relative group flex-shrink-0">
          <img
            src={
              user.avatar || `https://picsum.photos/seed/${user.uId}/200/200`
            }
              ...
              >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 rounded-2xl py-3 pl-12 pr-4 text-sm font-bold outline-none transition-all"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                ...
                <div className="flex gap-3 pt-2">
                  <button
                    ...
                    disabled={isUpdating}
                    className="flex-grow bg-blue-600 text-white px-6 py-3 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors shadow-lg"
                  >
                    {isUpdating ? (
                  ...
                  <button
                    ...
                    className="bg-slate-100 text-slate-600 px-6 py-3 rounded-2xl font-bold text-sm flex items-center justify-center gap-2"
                  >
                    <X size={18} /> Cancel
                  </button>
                </div>
                ...
                <div className="flex gap-3 justify-center md:justify-end">
                  {!isOwnProfile ? (
                    ...
                    <button
                      ...
                      className="px-8 py-3 bg-slate-900 text-white rounded-2xl font-bold text-sm shadow-lg hover:bg-slate-800 transition-all"
                    >
                      Edit Profile
                    </button>
                  )}
