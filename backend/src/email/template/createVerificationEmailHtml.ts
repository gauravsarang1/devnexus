export default function createVerificationEmailHtml(name: string, otp: string) {
    // HTML email template company name Skillswap
    return `
    <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
        <h2 style="color: #4CAF50;">Skillswap Account Verification</h2>
        <p>Hi ${name},</p>
        <p>Thank you for registering with Skillswap! To complete your registration, please use the following One-Time Password (OTP) to verify your email address:</p>
